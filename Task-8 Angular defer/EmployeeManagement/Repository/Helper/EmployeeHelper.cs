    ...
    public class EmployeeHelper : IEmployeeService
    {
        ...
        public async Task<ApiResponse> DeleteEmployee(int id)
        {
            ...
            try
            {
                ...
                {
                    response.Status = "Employee Not Exists";
                ...
                else
                {
                    ...
                    response.Status = "Employee Remove Success";
                    response.IsError = false;
                    response.HttpStatusCode = (int)HttpStatusCode.OK;
                }
        ...
        public async Task<ApiResponse> UpdateEmployee(EmployeeDto employeeDetails)
        {
            ...
            try
            {
                ...
                response.Status = "Employee Update Success";
                response.IsError = false;
                response.HttpStatusCode = (int)HttpStatusCode.OK;
            }
            catch (SqlException)
